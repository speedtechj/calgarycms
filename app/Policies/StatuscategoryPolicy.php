...
class StatuscategoryPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, Statuscategory $statuscategory)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, Statuscategory $statuscategory)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, Statuscategory $statuscategory)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, Statuscategory $statuscategory)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, Statuscategory $statuscategory)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(User $user, Statuscategory $statuscategory)
    {
