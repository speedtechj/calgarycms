...
class ReceiveraddressPolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\Receiveraddress  $receiveraddress
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, Receiveraddress $receiveraddress)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, Receiveraddress $receiveraddress)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, Receiveraddress $receiveraddress)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, Receiveraddress $receiveraddress)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, Receiveraddress $receiveraddress)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(User $user, Receiveraddress $receiveraddress)
    {
