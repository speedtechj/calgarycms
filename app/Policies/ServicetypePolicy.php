...
class ServicetypePolicy
{
    ...
    {
        return $user->can('delete_any_servicetype');
    }
    ...
    {
        return $user->can('force_delete_servicetype');
    }
    ...
    {
        return $user->can('force_delete_any_servicetype');
    }
    ...
    {
        return $user->can('restore_servicetype');
    }
    ...
    {
        return $user->can('restore_any_servicetype');
    }
    ...
    {
        return $user->can('replicate_servicetype');
    }
    ...
    {
        return $user->can('reorder_servicetype');
    }
